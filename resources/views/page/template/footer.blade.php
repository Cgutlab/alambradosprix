 ...
 <footer style="width: 100%; background: #272727; margin-top: 30px;">

 <div class="container yp25" style="width: 100%; height: 100%;">

 <div class="row cero" style="margin-bottom: 0px;">
      ...
      <div class="row">
        ...
        <div class="col l5 s6">
          ...
          <ul>
            ...
            <li class=""><a class="cero fs14 fw5 Raleway" href="{{url('productos/1')}}">ALAMBRADOS</a></li>

            <li class=""><a class="cero fs14 fw5 Raleway" href="{{url('productos/2')}}">PUERTAS Y PORTONES</a></li>

            <li class=""><a class="cero fs14 fw5 Raleway" href="{{url('productos/3')}}">POSTES</a></li>

            <li class=""><a class="cero fs14 fw5 Raleway" href="{{url('productos/4')}}">OTROS PRODUCTOS</a></li>
        ...
        <div class="col l7 s6">
          ...
          <ul>
            ...
            <li class=""><a class="cero fs14 fw5 Raleway" href="{{route('servicios')}}">SERVICIOS</a></li>

            <li class=""><a class="cero fs14 fw5 Raleway" href="{{route('trabajosrealizados')}}">TRABAJOS REALIZADOS</a></li>
