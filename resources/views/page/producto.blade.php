        ...
        <div style="margin-bottom: 10px;">
          ...
          <a href="{{($producto->id)}}">
            ...
            <span style="color: #4B4B4B; font-family: 'Raleway'; font-size: 16px; font-weight: 600;">              
              ...
              <span  class="Raleway" style="font-weight: 800;">
            ...
            <span style="color: #A4A4A4;">
              ...
              <span  class="Raleway" style="color: gray; font-weight: 600;">
  ...
  <div class="container" style="width: 95%;">
    ...
    <div class="row">
      ...
      <div class="container" style="width: 95%">
        ...
        <div style="color: #393185;"><h5 class="Raleway" style="margin-top: 0px; font-weight: 600;  line-height: 35px;">{{($productoIs->titulo)}}</h5></div>

        <div style="color: #393185;"><h6 class="Raleway" style="font-weight: 600;">{{($productoIs->breve)}}</h6></div>
        ...
        <div>
          ...
          <a href="{{route('presupuesto')}}" class="btn btn-ficha z-depth-0 " style="background: white; color:#D30000; font-family: 'Raleway'; font-weight: 600; width: 260px; height: 42px; padding: 0px; border: 3px solid #D30000; margin-top: 10px;" target="_blank">SOLICITAR PRESUPUESTO</a>
