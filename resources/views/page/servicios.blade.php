...
<div class="Raleway fs16 editorRico gris8" style="width: 70%;">
...
<div class="col m6 l3 s12" style="position: relative;" style="padding-bottom: 50px;">
  ...
  <div class="card z-depth-0 yp35">
    ...
    <div style="margin: 20px 10px; border-radius: 50%; border: 2px solid #2A4585; width: 125px; height: 125px; vertical-align: middle;  text-align: center;">

    <img src="{{asset('imagenes/servdestacados/'.$servdestacado->imagen)}}" style="margin: 16px;">
...
<div class="col s12 m12">
  ...
  <div class="card horizontal" style="margin-bottom: -7px; padding: 15px; ">
    ...
    <div class="card-stacked" style="background: white;">
      ...
      <div class="card-content" class="Raleway">

        <p style="margin-bottom: 20px;" class="Raleway ctitulo2 fs25"><b>{!!($servitem->titulo)!!}</b></p>

        <p class="Raleway">{!!($servitem->texto)!!}</p>
